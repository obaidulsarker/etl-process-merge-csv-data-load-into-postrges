...
table_name = "soda_hourly"

# Read SQL file
sql_file = open("etl\sql\soda_hourly_ins.sql", mode="r")
sql_ins = sql_file.read()
sql_file.close()

# use glob to get all the csv files 
source_path = os.getcwd() + "\\etl\\data\\hourly"
destination_path = os.getcwd() + "\\etl\\archive\\hourly"
