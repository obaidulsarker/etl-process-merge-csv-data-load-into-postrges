...
SELECT "datetime","Latitude", "Longitude", "Direct Inclined", "Diffuse Inclined", 
	...
	"Clear-Sky", "Top of Atmosphere", "Nb slots", "Temperature", "Relative Humidity", 
	"Pressure", "Wind speed", "Wind direction", "Rainfall", "Snowfall", "Snow depth" 
FROM stg.soda_daily AS stg
WHERE NOT EXISTS (SELECT 1 FROM public.soda_daily AS soda 
